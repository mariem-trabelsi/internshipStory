...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 21, 2022 at 07:18 PM
...
(3, 'admin', '123', 'https://cdn2.vectorstock.com/i/thumb-large/08/36/user-icon-vector-5770836.jpg', '----', '----', '----', '----', 'ADMIN'),
...
--
ALTER TABLE `hrs`
  MODIFY `ID_HR` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
